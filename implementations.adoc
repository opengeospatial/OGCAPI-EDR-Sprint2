...
| https://github.com/opengeospatial/ets-ogcapi-edr10[OGC API - Environmental Data Retrieval ETS (derived from OGC API - Features ETS)]
| Executable Test Suite
| https://github.com/ghobona[Gobe]
